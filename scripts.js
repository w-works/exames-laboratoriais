...
function atualizarOpcoes() {
    ...
    var caixaPesquisa = document.querySelector('.search-box');
    caixaPesquisa.value = '';
...
function limparEspacoExibirLembrete() {
    var espacoExibirLembrete = document.getElementById('espaco-exibir-lembrete');
    espacoExibirLembrete.innerHTML = "";
}

document.getElementById("selecao2").addEventListener("change", function () {
    limparEspacoExibirLembrete();
    atualizarSelecao3();
});

document.getElementById("selecao3").addEventListener("change", function () {
    limparEspacoExibirLembrete();
});
